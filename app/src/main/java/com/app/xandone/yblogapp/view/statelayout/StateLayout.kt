...
package com.app.xandone.yblogapp.view.statelayout
...
import com.app.xandone.yblogapp.view.statelayout.StateConfig.isNetworkingRetry
import com.app.xandone.yblogapp.view.statelayout.StateConfig.setRetryIds
import com.app.xandone.yblogapp.view.statelayout.Status.*
                ...
                if (status == EMPTY || status == ERROR) {
                    retryIds?.forEach {
                        targetStatusView.findViewById<View>(it)?.throttleClick {
                            showLoading(
                                tag = statusContainer[LOADING]?.tag,
                                silent = isNetworkingRetry && !isNetworking()
                            )
                        }
                    }
                }
