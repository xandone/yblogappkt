package com.app.xandone.yblogapp.widget;
...
public class ClassicsHeaderVisible extends ClassicsAbstract<ClassicsHeaderVisible> implements RefreshHeader {
...
//    public static String REFRESH_HEADER_UPDATE = "'Last update' M-d HH:mm";
    ...
    public ClassicsHeaderVisible(Context context) {
        this(context, null);
    }

    public ClassicsHeaderVisible(Context context, AttributeSet attrs) {
        super(context, attrs, 0);

        View.inflate(context, R.layout.v_srl_classics_header, this);
...
//            mLastUpdateText.setTextSize(12);
    ...
    public ClassicsHeaderVisible setLastUpdateTime(Date time) {
        final View thisView = this;
        mLastTime = time;
    ...
    public ClassicsHeaderVisible setTimeFormat(DateFormat format) {
    ...
    public ClassicsHeaderVisible setLastUpdateText(CharSequence text) {
        mLastTime = null;
    ...
    @Override
    public ClassicsHeaderVisible setAccentColor(@ColorInt int accentColor) {
        mLastUpdateText.setTextColor(accentColor&0x00ffffff|0xcc000000);
        return super.setAccentColor(accentColor);
    }

    public ClassicsHeaderVisible setEnableLastTime(boolean enable) {
        final View updateView = mLastUpdateText;
    ...
    public ClassicsHeaderVisible setTextSizeTime(float size) {
    ...
    public ClassicsHeaderVisible setTextSizeTime(int unit, float size) {
    ...
    public ClassicsHeaderVisible setTextTimeMarginTop(float dp) {
        final View updateView = mLastUpdateText;
    ...
    public ClassicsHeaderVisible setTextTimeMarginTopPx(int px) {
